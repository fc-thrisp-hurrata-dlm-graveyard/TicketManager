...
TODO: 
  ...
  - activerecord support -- but that would require more thought into tagging and future stuff, its a challenge to either keep simple or add functionality
